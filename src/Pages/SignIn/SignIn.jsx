                ...
                <div className="card w-[400px] shrink-0">
                    <form className="card-body">
                        ...
                        <div className="flex justify-between mb-2">
                            <button className="flex items-center justify-center text-black border border-gray-300 rounded-md py-2 px-4 w-[45%]" style={{
                                background: 'linear-gradient(97.97deg, rgb(228, 228, 228) 0.641%, rgb(255, 255, 255) 99.533%)',
                            }}>
                                <FcGoogle className="mr-2" />
                                Google
                            </button>
                            <button className="flex items-center justify-center text-white rounded-md py-2 px-4 w-[45%]" style={{
                        ...
                        <div className="form-control items-center justify-center mt-6">
                            <button className="rounded-md py-3 font-poppins text-xs text-white w-[200px] bg-[#156BCA]">Sign In</button>
                        </div>
